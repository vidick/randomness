...
The basic idea underlying our protocol is simple, and relies on the existence of a (post-quantum secure) family of trapdoor collision-resistant hash function (in short, TCF) $f:\{0,1\}^n \rightarrow \{0,1\}^m$.
